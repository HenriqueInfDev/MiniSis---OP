...
class SupplierEditWindow(QWidget):
    ...
    def delete_supplier(self):
        if not self.current_supplier_id:
            show_error_message(self, "Error", "Nenhum fornecedor carregado para inativar.")
            return

        reply = QMessageBox.question(self, "Confirmar Inativação", "Tem certeza que deseja inativar este fornecedor?", QMessageBox.Yes | QMessageBox.No, QMessageBox.No)
